    ...
    multipleUser :function(options){
        ...
        if(settings.selector != ''){
            ...
            settings.users.forEach(function (user, index){
                ...
                var image = 'https://smooht.com/assets/assets/user.png';
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container container-fluid">' +
                    ...
                    '<img class="icon" src="https://smooht.com/assets/assets/close.svg"></button></div></div>' +
